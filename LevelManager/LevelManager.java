...
public class LevelManager {
	...
	public void generateLevel(int level, float dt) {
		...
		if (!stepDone)
			switch(currentStep) {
			case 1:
				enemies.addAll(generateSquadron(Constants.WIDTH - 100, 100f, SquadronAlignment.DIAMOND, EnemyType.SMALL_ENEMY));
				enemies.addAll(generateSquadron(Constants.WIDTH - 100, 500, SquadronAlignment.DIAMOND, EnemyType.SMALL_ENEMY));
				enemies.addAll(generateSquadron(Constants.WIDTH - 100, 200, SquadronAlignment.TWO_V, EnemyType.BIG_ENEMY));
				stepDone = true;
				break;
			case 2:
				enemies.addAll(generateSquadron(Constants.WIDTH - 100, 200f, SquadronAlignment.TWO_H, EnemyType.SHOOTER_ENEMY));
				enemies.addAll(generateSquadron(Constants.WIDTH - 100, 300f, SquadronAlignment.TWO_V, EnemyType.SHOOTER_ENEMY));
				enemies.addAll(generateSquadron(Constants.WIDTH - 100, 300, SquadronAlignment.ONE, EnemyType.STATIC_SHOOTER_ENEMY));
				enemies.addAll(generateSquadron(Constants.WIDTH - 100, 300f, SquadronAlignment.ONE, EnemyType.STATIC_SHOOTER_ENEMY));
				stepDone = true;
				break;
			default:
			}
