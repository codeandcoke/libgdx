	...
	public void generateLevel(int level, float dt) {
		...
		if (!stepDone)
			...
			case 2:
				...
				enemies.addAll(generateSquadron(1000f, 300f, SquadronAlignment.TWO_V, EnemyType.SHOOTER_ENEMY));
				enemies.addAll(generateSquadron(900f, 300, SquadronAlignment.ONE, EnemyType.STATIC_SHOOTER_ENEMY));
				enemies.addAll(generateSquadron(950f, 300f, SquadronAlignment.ONE, EnemyType.STATIC_SHOOTER_ENEMY));
				stepDone = true;
				break;
			default:
			}
