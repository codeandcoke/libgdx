...
- **LevelManager**: Ejemplo de un `LevelManager`, la clase encargada de generar el nivel donde el usuario juega. En este ejemplo se crean niveles para un juego de naves, pero en [bombermax](https://github.com/sfaci/libgdx/tree/master/bombermanx) y [https://github.com/sfaci/libgdx/tree/master/jumper2dx] se pueden ver más ejemplos para otros tipos de juego
